...
#initializing pygame for sound effects
pygame.mixer.init()
...
sound_enable = pygame.mixer.Sound('SFX\enable_button.wav')
sound_game_start = pygame.mixer.Sound('SFX/new_game_sound_2.wav')
...
sound_game_completed = pygame.mixer.Sound('SFX/game-completed.wav')
...
#Resets the formating once the value in the cell is changed
def reset_highlight():
...
# Game modes
def easy_mode():
    sound_enable.play(maxtime=3000)
