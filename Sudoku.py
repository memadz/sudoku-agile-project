...
def SudokuGame():
    ...
    # Print Sudoku grids for debugging or answers. Remove comment on line 974 to enable the button.
    def print_grids():
        print("Sudoku Grid")
    ...
    #ttk.Button(button_frame, text="Print", style = "TButton", command=print_grids).grid(row=2, column=1, padx=5) # Uncomment to enable the print button
