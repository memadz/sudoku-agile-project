...
def SignUpPage():
    ...
    signup_button = ctk.CTkButton(frame, text="Sign Up", font=("Arial", 18), bg_color="#0078D4", fg_color="#0078D4", corner_radius=15, width=200, command=store_inputs)
    ...
    back_button = ctk.CTkButton(frame, text="Back", font=("Arial", 18), bg_color="#0078D4", fg_color="#0078D4", corner_radius=15, width=200, command=go_back)
