...
email_label = tk.Label(frame, text="Enter Your Email:", font=("Arial", 12), bg="white")
email_label.grid(row=1, column=0, columnspan=3, sticky="w", pady=(5, 0), padx=10)

email_field = tk.Entry(frame, justify='left', bg="#f7f7f7", font=("Arial", 12), width=40, bd=1, relief=tk.SOLID)
...
password_toggle_button = tk.Button(frame, text="Show", font=("Arial", 10), relief='flat', bg="#0078d4", fg="white", command=toggleMainPassword)
...
verify_password_toggle_button = tk.Button(frame, text="Show", font=("Arial", 10), relief='flat', bg="#0078d4", fg="white", command=toggleVerifyPassword)
verify_password_toggle_button.grid(row=6, column=2, pady=(0, 10), padx=10)



signup_button = tk.Button(frame, text="Sign Up", font=("Arial", 12), bg="#0078d4", fg="white", relief='flat', width=20, command=storeInputs)
...
login_button = tk.Button(frame, text="Already have an account? Login here.", font=("Arial", 10), bg="white", fg="#0078d4", relief='flat')
